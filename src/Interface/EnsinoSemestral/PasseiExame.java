...
public class PasseiExame extends javax.swing.JInternalFrame {
    ...
    private void btCalculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalculaActionPerformed
        try {
            ...
            ensinoSemestral.setNotaExame(Double.parseDouble(notaExame.getText()));
            if (ensinoSemestral.getNotaExame()<0){
                ensinoSemestral.setNotaExame(-ensinoSemestral.getNotaExame());
                this.notaExame.setText(String.valueOf(ensinoSemestral.getNotaExame()));
            }
            ...
            if (ensinoSemestral.mediaExameFinal() > 10) {
                if (ensinoSemestral.mediaExameFinal() >= 50) {
                    ...
                    lblResultado.setText(Double.toString(ensinoSemestral.mediaExameFinal()) + " Exame");
                }
