...
public class PasseiSemestre extends javax.swing.JInternalFrame {
    ...
    private void btCalculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCalculaActionPerformed
        try {
            ...
            ensinoTecnicoSemestral.setBimestre2(Double.parseDouble(nota2Bim.getText()));
            if (ensinoTecnicoSemestral.getBimestre2()<0){
                ensinoTecnicoSemestral.setBimestre2(-ensinoTecnicoSemestral.getBimestre2());
                this.nota2Bim.setText(String.valueOf(ensinoTecnicoSemestral.getBimestre2()));
            }
